...
$recentQuery = mysqli_query($conn, "SELECT n.pdf_id, n.title, n.subject, n.date, n.image_path, u.username FROM notes n LEFT JOIN users u ON n.user_id = u.id ORDER BY n.date DESC LIMIT 3");
...
<div class="hero">
    <div class="hero-main">
        ...
        <!-- Hero content -->
        <div class="hero-left">
            <h1 id="learn-text">Welcome to</h1>
            <h1 id="student-text">Student <span>Resource</span> Hub</h1>
            <p>Find high-quality notes, study materials and <br>resources shared by students, for students.</p>
            ...
            <div class="hero-buttons">
                <a href="includes/filter.php"><button type="button" class="btn note-btn">Explore Notes</button></a>
                <a href="includes/upload.php"><button type="button" class="btn browse-btn">Upload Notes</button></a>
            </div>
        </div>
    </div>
</div>
...
<section class="recent-notes">
    <div class="recent-header">
        ...
        <a href="includes/filter.php">View All →</a>
    </div>
            ...
            <?php foreach ($recentNotes as $note): ?>
                ...
                <div class="note-card">
                    ...
                    <div class="note-content">
                        ...
                        <p>By <?= htmlspecialchars($username) ?></p>

                        <div class="note-footer">
                            <span class="pdf">PDF</span>
                            <span>• <?= date("d M Y", $noteDate) ?></span>
